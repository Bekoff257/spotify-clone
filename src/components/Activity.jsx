...
const Activity = () => {
  const [ closeActivaty, setCloseActivaty ] = useState(false)

  function closeHandler(){
    setCloseActivaty(true)
  }

  return (
    <div className={closeActivaty ? 'close' : 'activity'}>
        <div className="container">
            <div className="act-content">
                ...
                <div className="settings-section">
                  ...
                  <div className="settings-btn_sect">
